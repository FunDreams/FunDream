...
-(CDataManager*) InitWithFileFromRes:(NSString*) sFileName
{
    ...
    if (self)
    {
        ...
        NSString *REZ=@"dump/";
        REZ=[REZ stringByAppendingString:sFileName];
        
        m_sFullFileName =  (NSMutableString *)[[NSBundle mainBundle] pathForResource:REZ ofType:@""];
...
//--------------------------------------------------------
-(CDataManager*) InitWithFileFromTemp:(NSString*) sFileName
{
    self = [super init];
    if (self)
    {
        ...
        cacheDirectory = [[cacheDirectory stringByDeletingLastPathComponent] stringByAppendingPathComponent:@"tmp"];
        ...
        if (m_sFullFileName != nil)
        {
            ...
            if (m_pDataDmp == nil)
            {
                ...
                NSURL *TmpUrl=[[NSURL alloc] initWithString:m_sFullFileName];
...
//--------------------------------------------------------
-(CDataManager*) InitWithFileFromDoc:(NSString*) sFileName
{
    self = [super init];
    if (self)
    {
