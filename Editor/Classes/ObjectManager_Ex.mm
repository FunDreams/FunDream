...
//------------------------------------------------------------------------------------------------------
- (void)SetPause:(int)iPause{
    (pStringContainer->ArrayPoints->pData)[Ind_PAUSE]=iPause;
}
//------------------------------------------------------------------------------------------------------
...
//рабочий цикл матрицы------------------------------------------------------------
    (pStringContainer->ArrayPoints->pData)[Ind_DELTATIME]=m_fDeltaTime;
    (pStringContainer->ArrayPoints->pData)[Ind_IS_IPAD]=m_pParent->m_bIpad;

    [pStringContainer->ArrayPoints delResource];

    FractalString *StartStr = [pStringContainer GetString:@"Objects"];
    [pStringContainer->pMainCycle Update:StartStr Place:-1];
//очистка touch====================================================
    InfoArrayValue *pInfo=(InfoArrayValue*)*pStringContainer->pMainCycle->ppXtouchBegin;
    pInfo->mCount=0;
    pInfo=(InfoArrayValue*)*pStringContainer->pMainCycle->ppYtouchBegin;
    pInfo->mCount=0;
    pInfo=(InfoArrayValue*)*pStringContainer->pMainCycle->ppNumtouchBegin;
    pInfo->mCount=0;

    pInfo=(InfoArrayValue*)*pStringContainer->pMainCycle->ppXtouchMove;
    pInfo->mCount=0;
    pInfo=(InfoArrayValue*)*pStringContainer->pMainCycle->ppYtouchMove;
    pInfo->mCount=0;
    pInfo=(InfoArrayValue*)*pStringContainer->pMainCycle->ppNumtouchMove;
    pInfo->mCount=0;

    pInfo=(InfoArrayValue*)*pStringContainer->pMainCycle->ppXtouchEnd;
    pInfo->mCount=0;
    pInfo=(InfoArrayValue*)*pStringContainer->pMainCycle->ppYtouchEnd;
    pInfo->mCount=0;
    pInfo=(InfoArrayValue*)*pStringContainer->pMainCycle->ppNumtouchEnd;
    pInfo->mCount=0;
    
    for (int i=0; i<10; i++) {
        (*pStringContainer->pMainCycle->ppLockTouch+SIZE_INFO_STRUCT)[i]=0;
    }
//--------------------------------------------------------------------------------
	NSEnumerator *enumeratorProc;
