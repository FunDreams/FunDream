...
@public
    ...
    Texture2D* TexIndicatroArrayCount;
    NSString *StrTexIndicatroArrayCount;

    Texture2D* TexIndicatrorGroupEnEx;
    NSString *StrTexIndicatrGroupEnEx;

    Texture2D* TexIndicatrorQueue;
//    NSString *StrTexIndicatrorQueue;
