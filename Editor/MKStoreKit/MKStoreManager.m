...
static NSString *featureAId = @"FullFunDreams_1";
...
{
	NSString *messageToBeShown = [NSString stringWithFormat:@"Reason: %@, You can try later", [transaction.error localizedFailureReason]];
