...
#import "Ob_EditorPoint.h"
#import "ConstantsAndMacros.h"
#import "Ob_Shape.h"

@implementation Ob_EditorPoint
//------------------------------------------------------------------------------------------------------
...
- (void)LinkValues{
    ...
    SET_CELL(LINK_VECTOR_V(PosParticle,m_strName,@"PosParticle"));
}
//------------------------------------------------------------------------------------------------------
- (void)PostSetParams{
    [super PostSetParams];
...
- (void)Start{
    ...
    SET_STAGE_EX(NAME(self), @"ProcBullet", @"Idle");    
}
//------------------------------------------------------------------------------------------------------
-(void)CreateOneParticle{
    ...
    Par->m_cColor=Color3DMake(1, 0, 1, 1);

    Par->m_vPos=PosParticle;
  //  Par->m_vPos.y-=5;
}
//------------------------------------------------------------------------------------------------------
